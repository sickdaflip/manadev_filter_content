 ...
 *
 */
class ManaPro_FilterContent_Helper_Block_Cms_AdditionalDescription extends ManaPro_FilterContent_Helper_Block {
    /**
    ...
    public function before($block, $key) {
        ...
        if ($newDescription = $this->rendererHelper()->get('additional_description')) {
            ...
            $page->setData('content', $oldDescription . $newDescription);
        }
    }
